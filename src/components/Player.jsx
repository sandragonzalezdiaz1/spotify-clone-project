...
export const Pause = () => (
    <svg  role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16"><path d="M2.7 1a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7zm8 0a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7z"></path>
    </svg>
)

export const Play = () => (
    <svg role="img" height="16" width="16 "aria-hidden="true" viewBox="0 0 16 16"><path d="M3 1.713a.7.7 0 0 1 1.05-.607l10.89 6.288a.7.7 0 0 1 0 1.212L4.05 14.894A.7.7 0 0 1 3 14.288z"></path>
    </svg>
)
...
//Creamos un componente con la cancion actual
        ...
        className="flex items-center gap-5 relative overflow-hidden">
            ...
            <h3 className="font-semibold text-base block">
                ...
                <span className="text-sm opacity-80">
                    {artists?.join(', ')} {/* Al principio, como no se reproduce nada artists seria null, para arreglarlo ponemos ? para que en ese caso devuelva undefined */}
                </span>
            </div>
        </div>
        ...
        <div class="flex justify-center gap-x-2">
         ...
         <Slider 
                    ...
                    onValueChange={(value) => {
                        ...
                        const volumeValue = newVolume / 100 /* El valor del volumen tiene que ser de 0 a 1 */
...
export function Player() {
    const { currentMusic, isPlaying, setIsPlaying, volume } = usePlayerStore(state => state); //Desestructuramos el estado global
